...
const KitchenAccesories = () => {
  ...
  return (
    <div className="  bg-gray-300 flex flex-col items-center dark:text-white dark:bg-gray-800">
      <div className="sm:w-1/2 w-3/4 text-start shadow-lg dark:bg-gray-700 relative mb-10 h-20 bg-gray-500 text-white mt-5 flex items-center rounded-lg">
            ...
            p.category == "kitchen-accessories" && (
              ...
              >
                ...
                <CardBody className="text-center flex items-center flex-col">
                  ...
                  <Typography
                    className="font-medium text-black flex dark:text-white gap-1"
                    textGradient
                  >
