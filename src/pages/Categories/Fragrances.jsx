...
const Fragrances = () => {
  ...
  return (
    <div className=" bg-gray-300 flex flex-col items-center dark:bg-gray-800">
      <div className="sm:w-1/2 w-3/4 text-start shadow-lg relative dark:bg-gray-700 mb-10 h-20 bg-gray-500 text-white mt-5 flex items-center rounded-lg">
      ...
      <div className="flex flex-wrap container m-auto ">
        {HomeProducts?.products?.map(
          (p, i) => p.category == "fragrances" && <ProductCard key={i} p={p} />
        )}
      </div>
    </div>
  );
