...
const Furniture = () => {
  ...
  return (
    <div className=" bg-gray-300 flex flex-col items-center dark:bg-gray-800 dark:text-white">
      <div className="sm:w-1/2 w-3/4 text-start shadow-lg relative mb-10 h-20  bg-gray-500 dark:bg-gray-700 text-white mt-5 flex items-center rounded-lg">
        ...
        {HomeProducts?.products?.map(
          (p, i) =>
            p.category == "furniture" && (
              <Card
                key={i}
                className="w-72 bg-white dark:bg-gray-700 dark:text-white text-black m-auto relative mb-5 "
              >
